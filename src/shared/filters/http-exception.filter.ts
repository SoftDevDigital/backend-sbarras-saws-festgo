  ...
  private readonly logger = new CustomLoggerService();
    ...
    try {
      ...
      if (!response.headersSent) {
        ...
        this.logger.warn(
          `[${errorId}] Response already sent, cannot send error response`,
          'HttpExceptionFilter',
        );
      }
    } catch (filterError) {
      ...
      this.logger.error(
        `[${errorId}] Critical error in exception filter:`,
      ...
      try {
        ...
        this.logger.error(
          `[${errorId}] CRITICAL: Cannot send any response to client:`,
